...
REASONS = {
    ...
    "main_page": "правка защищённой страницы (catalog.html / sourdough-shop.html)",
    "main_page_shell": "запись в защищённую страницу через shell",
    "api_url_in_html": "адрес API в странице",
    "secret_in_edit": "ключ Anthropic в правке файла",
    "secret_shell": "запись ключа Anthropic через shell",
}
